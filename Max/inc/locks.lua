...
if not we_sudo(msg) then return "💀*¦ * هاد الامر للمطور الاساسي بس  \n🐸" end
if redis:get(boss..'lock_twasel') then
return '😑♂️*¦* هلا تم تعطيل \n📡*¦* التواصل بالتاكيد تم تعطيله \n✓'
else
...
if not we_sudo(msg) then return "💀*¦ * هاد الامر مطور لاساسي بس نضب  \n🐸" end
...
if not we_sudo(msg) then return "📡*¦* هاد الامر مطور الاساسي بس 🐸" end
if not redis:get(boss..'lock_brod') then
return '🙋🏼‍♂️*¦* هلا قلبي \n📡*¦* اذاعة المطورين بالتاكيد تم تعطيل \n✓'
else
redis:del(boss..'lock_brod')
return '🙋🏼‍♂️*¦* هلا قلبي \n📡*¦* تم تعطيل اذاعة المطورين  \n✓'
end
end
function unlock_brod(msg)
if not we_sudo(msg) then return "📡*¦* هاد الامر مطور الاساسي بس 🐸" end" end
...
if not is_mod(msg) then return"📡*¦* هاد الامر مطور الاساسي بس 🐸  " end
...
if not is_mod(msg) then return "📡*¦* هاد الامر لاادمن بس   🚶" end
...
return '🙋🏼‍♂️*¦* هلا قلبي \n📡*¦* تم تشعيل نظام البوت خدمي \n✓\n🚸¦ اصبح البوت الان بامكان اي شخص\n🔚¦ ان يستخدم البوت للتفعيل'
end
end

---------------Lock Link-------------------
function lock_link(msg)
if not is_mod(msg) then return "📡*¦* هاد الامر.خاص بل الادمن بس  🚶" end
...
if not is_mod(msg) then return "📡*¦* هد الامر خاص بل الادمن بس  🚶" end
if not redis:get(boss..'lock_link'..msg.to.id) then
return '🙋🏼‍♂️*¦* هلا قلبي \n📡*¦* _الروابط بالتأكيد تم فتحها \n✓'
else 
