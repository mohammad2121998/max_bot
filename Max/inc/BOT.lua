--[[
<< تم برمجة وتعديل السورس من قبل مطورين >>
<<         @Mylove21231  
]]
function load_proc()
...
local url , res = https.request('https://blcon.tk/getuser/?username='..SUDO_USER)
if res ~= 200 then
...
..'\27[0;31m'..[[¦ Dev : @XBMBX]]..'\27[m\27[0;32m\n\n\027[0;32m'   
...
send_msg(redis:get(_info.TOKEN:match("(%d+)")..":WITTING:ON"), '💀*¦* تم اعادة تفعيل البوت بنجاح مح ✓', nil, 'md')
...
print('\n\27[0;32mPlugins is : '..#list_plug..' Are Active.\n\n\27[0;31mThe SOURCE RUN IS Max_bot v'..redis:get(boss..':VERSION')..'...\n\27[m')
end
load_plugins()
